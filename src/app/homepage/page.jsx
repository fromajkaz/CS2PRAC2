...
const Homepage = () => {
  return (
    <>
      <main className={`${orbitron} mx-auto px-5 text-center  `} >
      <div className='mt-10'>
        ...
        <Link className='' href="/pick">      
          <button className='py-5 px-10 bg-[#161a31] w-[300px] md:w-[400px] mx-auto flex items-center justify-center rounded-md gap-2 hover:bg-black duration-700 transition-all'>{hero.button} <MdArrowOutward /></button>
        </Link>
      </div>
    </main>
    </>
